...
?>
<table role="presentation" class="kdna-events-email-details" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;margin:20px 0 12px;">
	<?php if ( ! empty( $cells ) ) : ?>
		<tr>
